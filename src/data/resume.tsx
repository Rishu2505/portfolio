...
export const DATA = {
  ...
  summary:
    `I’m a seasoned Software Development Engineer with 9+ years of experience in mobile app development (React Native, Android, iOS, JavaScript, TypeScript). I design and deliver scalable, high-performance mobile applications across HealthTech, EdTech, Charity, E-Commerce, and Social Platforms — guiding projects from concept to App Store / Play Store launch. I excel in fast-paced, collaborative environments, translating complex requirements into robust, user-centric solutions that elevate user experience and set industry benchmarks. Passionate about clean, maintainable code and agile development, I continuously explore emerging technologies while driving technical excellence, mentorship, and innovation. I embrace opportunities — full-time, contract, part-time, or freelance — to create impactful, scalable products and contribute at a strategic level.`,
  avatarUrl: "/me.png",
  skills: [
    "React Native",
    "JavaScript",
